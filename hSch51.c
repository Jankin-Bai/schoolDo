...
TATWITY_ID=hSCH_ADDATION(do_X，1000，0，0)；
使函数do_x()在1000刻度后执行一次。
(先发制人任务)。

Task_ID = hSCH_Add_Task（Do_X，0,1000,1）;。
使函数do_x()定期执行，每1000刻度。
(合作任务)。

TABLE_ID=hSCH_ADDATION(do_X，300，1000，0)；
使函数do_x()定期执行，每1000刻度。
任务将首先在T = 300刻度处执行，然后在1300,2300等处执行。
(先发制人任务)
-*------------------------------------------------------------------*/
